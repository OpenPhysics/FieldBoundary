...
export const LIGHT_SURFACE_TEXT_FILL = FieldBoundaryColors.controlSurfaceTextColorProperty;

/**
 * Combo-box chrome for panels. Item labels must use {@link LIGHT_SURFACE_TEXT_FILL}, not
 * {@link FieldBoundaryColors.textColorProperty} — that color is for labels on the dark panel fill.
 */
export const FIELD_BOUNDARY_COMBO_BOX_OPTIONS = {
  buttonFill: FieldBoundaryColors.controlSurfaceColorProperty,
  listFill: FieldBoundaryColors.controlSurfaceColorProperty,
  buttonStroke: FieldBoundaryColors.panelBorderColorProperty,
  listStroke: FieldBoundaryColors.panelBorderColorProperty,
...
export const TIME_CONTROL_SPEED_RADIO_OPTIONS = {
  speedRadioButtonGroupOptions: {
    labelOptions: { fill: FieldBoundaryColors.textColorProperty },
  },
